      ...
      <div class="row">
         ...
         <main class="col-md-9  order-1 order-md-2">
            <div>
               <div class="card">
                  <div class="card-body">
                     <form act-on="submit" act-request="{{ route('website.address.update', [ 'address' => $address->id ]) }}">
                        @csrf
                          ...
                          <div class="form-row mb-2">
                              <div class="col-12 col-md-6 form-group">
                                 <div class="input-wrapper">
                                    ...
                                    <input type="text" id="name" name="name" value="{{ $address->name }}" required class="form-control"  placeholder="{{ __('Enter Name') }}">
                                 </div>
                              </div>
                              <div class="col-12 col-md-6 form-group">
                                 <div class="input-wrapper">
                                    <label class="label" for="mobile">{{ __('Mobile Number') }} <span class="text-danger">*</span></label>
                                    <input type="tel" id="mobile" name="mobile" value="{{ $address->mobile }}"  class="form-control"  placeholder="{{ __('Enter Mobile Number') }}">
                                 </div>
                              </div>
                          </div>
                          <div class="form-row mb-2">
                              <div class="col-12 col-md-6 form-group">
                                 <div class="input-wrapper">
                                    ...
                                    <input type="text" id="line_1" name="line_1" value="{{ $address->line_1 }}" required class="form-control"  placeholder="{{ __('Enter Address (Eg: House, Company, Building, Villa, Flat No.)') }}">
                                 </div>
                              </div>
                              <div class="col-12 col-md-6 form-group">
                                 <div class="input-wrapper">
                                    <label class="label" for="line_2">{{ __('Area and Street') }} <span class="text-danger">*</span></label>
                                    <input type="text" id="line_2" name="line_2" value="{{ $address->line_2 }}" required class="form-control"  placeholder="{{ __('Enter Area and Street (Eg: Road, Avenue, Block No.)') }}">
                                 </div>
                              </div>
                          </div>
                          <div class="form-row mb-2">
                              <div class="col-12 col-md-6 form-group">
                                 <div class="input-wrapper">
                                    ...
                                    <input type="text" id="line_3" name="line_3" value="{{ $address->line_3 }}" class="form-control"  placeholder="{{ __('Enter Landmark (Optional)') }}">                    
                                 </div>
                              </div>
                              <div class="col-12 col-md-6 form-group">
                                 <div class="input-wrapper">
                                    ...
                                    <select id="pincode_id" name="pincode_id" required class="form-control custom-select">
                                       ...
                                       <option value="{{ $pincode->id }}" @if($address->pincode_id == $pincode->id) selected @endif>{{ $pincode->pincode }}@if($pincode->area) ({{ $pincode->area }})@endif</option>
                                       @endforeach
                                    </select>
                                    @else
                                    ...
                                    <select id="location_id" name="location_id" required class="form-control custom-select">
                                       ...
                                       @foreach($states as $state)
                                         ...
                                         <optgroup label="{{ _local($state->name, $state->local_name) }}">
                                           ...
                                           <option value="{{ $location->id }}" @if($address->location_id == $location->id) selected @endif>{{ _local($location->name, $location->local_name) }}</option>
                                           @endforeach
                                         </optgroup>
                                         @endif
                                       @endforeach
