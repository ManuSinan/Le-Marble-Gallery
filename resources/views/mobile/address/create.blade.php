<div class="appHeader bg-primary text-light" style="background-color: #1F2937 !important;">
    ...
    @if($type == 'select')
    <div class="pageTitle" style="font-family: 'Playfair Display', serif; font-weight: 600; color: #fff !important;">{{ __('New Delivery Site') }}</div>   
    @else
    <div class="pageTitle" style="font-family: 'Playfair Display', serif; font-weight: 600; color: #fff !important;">{{ __('Add Address') }}</div>
    @endif
...
<div class="appCapsule" style="background-color: #F8F8F8;">
    ...
    <div class="mt-3">
        ...
        <form act-on="submit" act-request="{{ route('mobile.address.save', ['view' => $type]) }}">
            <div class="section mt-1 px-3">
                ...
                <div class="form-group basic mb-2">
                    <div class="input-wrapper">
                        ...
                        <input type="text" id="name" name="name" required class="form-control" placeholder="{{ __('Enter Client Name or Project Reference') }}" style="border-radius: 4px; border: 1px solid #d1d5db; padding: 10px; font-family: 'Inter', sans-serif;">
                ...
                <div class="form-group basic mb-2">
                    <div class="input-wrapper">
                        ...
                        <input type="tel" id="mobile" name="mobile" required class="form-control" placeholder="{{ __('Enter Contact Mobile Number') }}" style="border-radius: 4px; border: 1px solid #d1d5db; padding: 10px; font-family: 'Inter', sans-serif;">
                        <span class="clear-input">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                        </span>
                    </div>
                ...
                <div class="form-group basic mb-2">
                    <div class="input-wrapper">
                        ...
                        <input type="text" id="line_1" name="line_1" required class="form-control" placeholder="{{ __('Eg: Villa/Plot No., Building Name, Floor') }}" style="border-radius: 4px; border: 1px solid #d1d5db; padding: 10px; font-family: 'Inter', sans-serif;">
                        <span class="clear-input">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                        </span>
                    </div>
                ...
                <div class="form-group basic mb-2">
                    <div class="input-wrapper">
                        ...
                        <input type="text" id="line_2" name="line_2" required class="form-control" placeholder="{{ __('Eg: Road name, Sector, Zone') }}" style="border-radius: 4px; border: 1px solid #d1d5db; padding: 10px; font-family: 'Inter', sans-serif;">
                        <span class="clear-input">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                        </span>
                    </div>
                ...
                <div class="form-group basic mb-2">
                    <div class="input-wrapper">
                        ...
                        <input type="text" id="line_3" name="line_3" class="form-control" placeholder="{{ __('Enter Landmark details') }}" style="border-radius: 4px; border: 1px solid #d1d5db; padding: 10px; font-family: 'Inter', sans-serif;">
                        <span class="clear-input">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                        </span>
                    </div>
            ...
            <div class="appBottomMenu pt-2 pb-2 px-3" style="position: relative; box-shadow: none; background: transparent; height: auto; border: none;">
                <button type="submit" class="btn btn-primary btn-block btn-lg shadow-sm" style="background-color: #1F2937 !important; border-color: #1F2937 !important; font-family: 'Inter', sans-serif; font-weight: bold; border-radius: 4px; padding: 12px;">{{ __('Save and Continue') }}</button>
            </div>
            @else
            <div class="section full mb-5 px-3">
                <div class="wide-block pt-2 pb-2" style="background: transparent; border: none; padding: 0;">
                    <button type="submit" class="btn btn-primary btn-block shadow-sm" style="background-color: #1F2937 !important; border-color: #1F2937 !important; font-family: 'Inter', sans-serif; font-weight: bold; border-radius: 4px; padding: 12px;">{{ __('Save Address') }}</button>
                </div>
            </div>
            @endif
