<div class="appHeader bg-primary text-light">
    ...
    <div class="pageTitle">{{ __('Change Password') }}</div>
    <div class="right">
        <a href="{{ route('mobile.cart',['referral' => route('mobile.change.password')]) }}" class="headerButton cart">
...
<div class="appCapsule">
    ...
    <div class="mt-1">
        ...
        <form act-on="submit" act-request="{{ route('mobile.change.password.request') }}">
            <div class="section mt-1">

                <div class="form-group basic mb-1">
                    <div class="input-wrapper">
                        <label class="label" for="current-password">{{ __('Current Password') }} <span class="text-danger">*</span></label>
                        <input type="password" id="current-password" name="current-password" required class="form-control"  placeholder="{{ __('Enter Current Password') }}">
                ...
                <div class="form-group basic mb-1">
                    <div class="input-wrapper">
                        <label class="label" for="password">{{ __('New Password') }} <span class="text-danger">*</span></label>
