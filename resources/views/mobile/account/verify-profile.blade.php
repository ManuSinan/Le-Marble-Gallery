...
<div class="appCapsule">
    ...
    <form act-on="submit" act-request="{{ route('mobile.verify.profile') }}">
        <div class="mt-3">
            <div class="section mb-5">

                <div class="form-group basic mb-1">
                    <div class="input-wrapper mb-1">
                        <label class="label" for="otp">{{ __('An OTP has been sent to:') }} {{ $mobile }}</label>
                ...
                <div class="form-links mt-2">
                    <div>
                        <a href="{{ route('mobile.edit.profile') }}">{{ __('Try again') }}</a>  
                    </div>
                </div>
