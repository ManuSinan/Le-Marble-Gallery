                        ...
                        <div class="tab-content">
                           <div class="tab-pane active show" id="tabs-create-form">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                       <label>{{ __('Stock Available') }} <span class="stock-unit"></span></label>
                                       <div>
                                          <input type="text" id="stock_available" name="stock_available" disabled class="form-control input-mask" data-inputmask="'alias': 'decimal', 'digits': 2, 'allowMinus': false, 'rightAlign': false">
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                       <label>{{ __('Minimum Quantity') }} <span class="stock-unit"></span> <span class="text-danger">*</span></label>
                                       <div>
                                          <input type="text" id="minimum_quantity" name="minimum_quantity" required  class="form-control input-mask" data-inputmask="'alias': 'decimal', 'digits': 2, 'allowMinus': false, 'rightAlign': false">
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                       <label>{{ __('Price') }} <span class="price-unit"></span>  <span class="text-danger">*</span></label>
                                       <div>
                                 ...
                                 <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                       <label>{{ __('Selling Price') }} <span class="price-unit"></span> <span class="text-danger">*</span></label>
                                       <div>
                                          ...
                                          <div class="row">
                                             ...
                                             <div class="col-sm-12">
                                                <div class="form-group">
                                                   ...
                                                   <div>
                                                      <textarea class="form-control"  name="keywords" placeholder="Enter Comma Separated Keywords Eg: Apple, Red Apple, Purchase Apple Fruit" rows="2"></textarea>
                                                   </div>
                                                </div>
                                             </div>
                              ...
                              <div id="variable-product-inputs" class="row d-none">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div>
                                             <select id="combination" class="form-select select2">
                                                ...
                                                <option value="existing">{{ __('Existing') }}</option>
                                             </select>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                       ...
                                       <div id="combination-name-existing" class="d-none">
                                          <select name="combination_key" disabled class="form-select select2 w-100 combination_key">
                                             <option value="">&nbsp;</option>
                                       ...
                                       <div id="combination-name-new">
                                          <input type="text" name="combination_key" class="form-control combination_key">
                                       </div>
                                    </div>
                                 </div>
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-lg-8 col-sm-12">
                                          <div class="form-group">
                                             <label>{{ __('Description') }} </label>
                                             <div>
                                                <input type="text" name="local_description" class="form-control">
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                 ...
                                 <div class="row">
                                    <div class="col-sm-12">
                                       <div class="form-group">
                                          ...
                                          <div>
                                             <textarea name="rich_description" style="display:none"></textarea>  
                                             <div for="rich_description" class="editor" style="min-height:350px"></div>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
