    ...
    <div class="col-md-4 col-sm-12">
        <div class="mb-1">
            <ol class="breadcrumb breadcrumb-alternate" aria-label="breadcrumbs">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="javascript:;">{{ __('Books') }}</a></li>
            </ol>
        </div>
        <h2 class="page-title" act-on="click">{{ __('Books') }}</h2>
    </div>
            ...
            <table act-sort='[[ 0, "DESC" ]]' act-datatable="{{ route('product.list') }}" search="#search" class="table card-table table-vcenter text-nowrap datatable">
                <thead>
                    <tr class="bg-transparent">
                        ...
                        <th name="product_code" priority="8">Book Code</th>
                        <th name="name" priority="2">Book Name</th>
