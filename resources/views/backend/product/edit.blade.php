...
<div class="row">
   <div class="col-lg-12">
      <div class="card px-2">
         <div class="card-body">
            <form act-on="submit" act-request="{{ route('product.update', ['product' => $product->id]) }}" act-image-compress="image, gallery_image_1, gallery_image_2, gallery_image_3">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                       ...
                                       <div>
                                          <input type="text" value="{{ $product->slug }}" id="slug" name="slug"  required   class="form-control">
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                       ...
                                       <div>
                                          <input type="text" value="{{ $product->price }}"  name="price"  required   class="form-control input-mask" data-inputmask="'alias': 'decimal', 'digits': {{ decimalPlace() }}, 'allowMinus': false, 'rightAlign': false">
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                       ...
                                       <div>
                                          <input type="text" value="{{ $product->selling_price }}" name="selling_price" required  class="form-control input-mask" data-inputmask="'alias': 'decimal', 'digits': {{ decimalPlace() }}, 'allowMinus': false, 'rightAlign': false">
                                       </div>
                                    </div>
                                 </div>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-sm-12">
                                    <div class="form-group">
                                       ...
                                       <div>
                                          <textarea name="private_note"class="form-control" cols="30" rows="5">{{ getOption('product_' . $product->id . '_private_note') }}</textarea>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-sm-12">
                                    <div class="form-group">
                                       ...
                                       <div>
                                          <input type="text" name="meta_title" value="{{ getOption('product_' . $product->id . '_meta_title') }}" class="form-control">
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-sm-12">
                                    <div class="form-group">
                                       ...
                                       <div>
                                          <textarea class="form-control"  name="meta_description" rows="2">{{ getOption('product_' . $product->id . '_meta_description') }}</textarea>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-sm-12">
                                    <div class="form-group">
                                       ...
                                       <div>
                                          <textarea class="form-control"  name="meta_keywords" placeholder="Enter Comma Separated Keywords Eg: Apple, Red Apple, Purchase Apple Fruit" rows="2">{{ getOption('product_' . $product->id . '_meta_keywords') }}</textarea>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-sm-12">
                                    <div class="form-group">
                                       ...
                                       <div>
                                          <textarea class="form-control"  name="gallery_video" placeholder="Youtube Embed Code" rows="2">{{ $product->gallery_video }}</textarea>
                                       </div>
                                    </div>
                                 </div>
