...
@if($item['type']  == 'image')
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="{{ $item['name'] }}" accept="image/*">
                                        <label class="custom-file-label" for="image">Choose file</label>
                                        <div class="py-2 d-flex">
                                        <img src="__[ asset('assets/images/image.svg') ]__" class="img-thumbnail custom-file-preview" width="150"/>
                                        </div>
                                    </div>                 
@endif
