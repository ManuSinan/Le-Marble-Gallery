...
<div class="row align-items-center">
    <div class="col-md-4 col-sm-12">
        <div class="mb-1">
            <ol class="breadcrumb breadcrumb-alternate" aria-label="breadcrumbs">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="javascript:;">{{ __('Locations') }}</a></li>
            </ol>
        </div>
        <h2 class="page-title" act-on="click">{{ __('Delivery Locations') }}</h2>
    </div>
    <div class="col-auto ms-auto d-print-none">
        <div class="d-flex">
            ...
            @if(hasPermission('location.store'))
...
<div class="row">
    <div class="col-lg-12">
         <div class="table-responsive">
            <table act-datatable="{{ route('location.list') }}" search="#search" class="table card-table table-vcenter text-nowrap datatable">
            <thead>
        ...
        <div class="modal fixed-left fade" id="create-form" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-aside" role="document">
                <div class="modal-content fix-padding">
                    <form act-on="submit" act-request="{{ route('location.store') }}">
                                        ...
                                        <div class="tab-pane active show" id="tabs-create-form">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <label>{{ __('Delivery Charge upto Cart Amount') }} </label>
                                                    <div>
                                                        <input type="text" name="delivery_cart_amount"  class="form-control input-mask" data-inputmask="'alias': 'decimal', 'digits': {{ decimalPlace() }}, 'allowMinus': false, 'rightAlign': false">
                                                    </div>
                                                </div>
                                            </div>
        ...
        <!-- /.modal -->
        @endif
        @if(hasPermission('location.edit'))
        <!--  edit form modal  -->
