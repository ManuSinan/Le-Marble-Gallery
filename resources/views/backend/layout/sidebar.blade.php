<div id="clock" class="widget clock mb-4">
        ...
        <div class="card-body">
            ...
            <div class="col">
                ...
                <div class="text-muted">
                    ...
                    <a href="{{ route('stock', ['max' => 0, 'title' => 'Out of Stock']) }}">
                        {{ \App\Models\Product::outOfStock()->count() }} {{ __('Out of stock') }}
                    </a>
                    @else
                        {{ \App\Models\Product::outOfStock()->count() }} {{ __('Out of stock') }}
                    @endif
        ...
        <div class="card-body">
            ...
            <div class="col">
                <div class="font-weight-medium">
                    ...
                    <a href="{{ route('order') }}">
                        {{ \App\Models\Order::count() }} {{ __('Orders') }}
                    </a>
                    @else
                        {{ \App.Models\Order::count() }} {{ __('Orders') }}
                    @endif
                ...
                <div class="text-muted">
                    {{ \App\Models\Order::whereDate('created_at', Carbon\Carbon::today())->count() }} {{ __('Ordered today') }}
                </div>
            </div>
            </div>
        </div>
    ...
    <div class="col-12 mt-3">
        ...
        <div class="card-body">
            ...
            <div class="col">
                ...
                <div class="text-muted">
                    {{ App\Models\User::whereDate('created_at', Carbon\Carbon::today())->count() }} {{ __('Registered today') }}
                </div>
            </div>
            </div>
        </div>
