...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('favicons/knm-logo.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('favicons/knm-logo.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('favicons/knm-logo.png') }}">
    <link rel="shortcut icon" href="{{ asset('favicons/knm-logo.png') }}">
    <link rel="apple-touch-icon" href="{{ asset('favicons/knm-logo.png') }}">
