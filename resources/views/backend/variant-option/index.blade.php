    ...
    <div class="col-auto ms-auto d-print-none filters">
        <div class="d-flex">
            ...
            <div class="filter" style="max-width:300px;">
                <select name="filter_variant" required class="custom-select select2 datatable-fliter">
                    <option selected value="">{{ __('Filter Variant') }}</option>
         ...
         <div class="table-responsive">
            ...
            <thead>
                    <tr class="bg-transparent">
                        ...
                        <th name="variant_name">Variant</th>
                                            ...
                                            <div class="tab-pane" id="tabs-create-local-lang">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <label>{{ __('Value') }} </label>
                                                        <div>
                                                            <input type="text" name="local_value"   class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
