    ...
    <div class="col-md-4 col-sm-12">
        <div class="mb-1">
            <ol class="breadcrumb breadcrumb-alternate" aria-label="breadcrumbs">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="javascript:;">{{ __('Categories') }}</a></li>
            </ol>
        </div>
        <h2 class="page-title" act-on="click">{{ __('Categories') }}</h2>
    </div>
            ...
            <div class="filter search">
                <div class="input-icon">
                    <form act-on="submit" action="/">
                        <input type="search" id="search" class="form-control" value="{{ $search }}" placeholder="Search {{ __('Categories') }}">
         ...
         <div class="table-responsive">
            ...
            <thead>
                    <tr class="bg-transparent">
                        ...
                        <th name="subcategories">Sub-categories</th>
