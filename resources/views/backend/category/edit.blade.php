        ...
        <div class="row">
            ...
            <div class="card">
                    <ul class="nav nav-tabs mb-2" data-bs-toggle="tabs">
                        ...
                        @endif
                        <li class="nav-item">
                            <a href="#tabs-edit-advance" class="nav-link" data-bs-toggle="tab">{{ __('Advanced Options') }}</a>
                        </li>
                    </ul>
                    <div class="card-body">
                    <div class="tab-content">
                                    ...
                                    <div>
                                        <div class="custom-file">
                                            ...
                                            <div class="preview">
                                                ...
                                                @else
                                                <img src="{{ asset('uploads/' . $category->image) }}" class="custom-file-preview"/>
                                                @endif
                                            </div>
                                    ...
                                    <div>
                                        <select name="priority" required class="form-select select2">
                                            @foreach(priority() as $priorityKey => $priorityValue)
                                                ...
                                                @if($category->priority == $priorityKey)
                        ...
                        <div class="tab-pane" id="tabs-edit-local-lang">
                            <div class="col-sm-12">
                                ...
                                <label>{{ __('Name') }} </label>
                                    <div>
                                        <input type="text" name="local_name" value="{{ $category->local_name }}"   class="form-control">
                        ...
                        <div class="tab-pane" id="tabs-edit-advance">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div>
                                        <input type="text" name="meta_title" value="{{ getOption('category_' . $category->id . '_meta_title') }}" class="form-control">
                                    </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div>
                                        <textarea class="form-control"  name="meta_description" rows="2">{{ getOption('category_' . $category->id . '_meta_description') }}</textarea>
                                    </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div>
                                        <textarea class="form-control"  name="meta_keywords" placeholder="Enter Comma Separated Keywords Eg: Apple, Red Apple, Purchase Apple Fruit" rows="2">{{ getOption('category_' . $category->id . '_meta_keywords') }}</textarea>
                                    </div>
                                    </div>
                                </div>
