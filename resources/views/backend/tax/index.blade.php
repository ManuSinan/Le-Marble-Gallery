    ...
    <div class="col-md-4 col-sm-12">
        <div class="mb-1">
            <ol class="breadcrumb breadcrumb-alternate" aria-label="breadcrumbs">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="javascript:;">{{ __('Tax') }}</a></li>
            </ol>
        </div>
        <h2 class="page-title" act-on="click">{{ __('Tax') }}</h2>
    </div>
...
<div class="row">
    <div class="col-lg-12">
         <div class="table-responsive">
            <table act-datatable="{{ route('tax.list') }}" search="#search" class="table card-table table-vcenter text-nowrap datatable">
            <thead>
                    <tr class="bg-transparent">
                        <th name="id" priority="1" width="8%">SL</th>
                        <th name="name">Name</th>
                        <th name="short">Short</th>
                        <th name="percentage">Percentage</th>
        ...
        <div class="modal fixed-left fade" id="create-form" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-aside" role="document">
                <div class="modal-content fix-padding">
                    <form act-on="submit" act-request="{{ route('tax.store') }}">
                        <div class="modal-header">
                            <h4 class="modal-title">{{ __('Add Tax') }}</h4>
                        </div>
                                        ...
                                        <div class="tab-pane active show" id="tabs-create-form">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <label>{{ __('Short') }}  <span class="text-danger">*</span></label>
                                                    <div>
                                                        <input type="text" name="short"  required   class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <label>{{ __('Percentage') }}  <span class="text-danger">*</span></label>
                                                    <div>
                                                        <input type="text" name="percentage"  required   class="form-control input-mask" data-inputmask="'alias': 'decimal', 'digits': {{ decimalPlace() }}, 'allowMinus': false, 'rightAlign': false">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane" id="tabs-create-local-lang">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <label>{{ __('Short') }} </label>
                                                    <div>
                                                        <input type="text" name="local_short"   class="form-control">
                                                    </div>
                                                </div>
                                            </div>
