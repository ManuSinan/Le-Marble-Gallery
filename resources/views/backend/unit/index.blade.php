                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active show" id="tabs-create-form">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <label>{{ __('Stepper') }}  <span class="text-danger">*</span></label>
                                                    <div>
                                                        <input type="text" name="stepper"  required   class="form-control input-mask" data-inputmask="'alias': 'decimal', 'digits': 2, 'allowMinus': false, 'rightAlign': false">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane" id="tabs-create-local-lang">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <label>{{ __('Type') }} </label>
                                                    <div>
                                                        <input type="text" name="local_type"   class="form-control">
                                                    </div>
                                                </div>
                                            </div>
