...
class OptionController extends Controller
{
    ...
    public function importUpdates(Option $option)
    {
        return view('backend/option/import-updates');
    }
    ...
    public function safetyTips(Option $option)
    {
        return view('backend/option/safety-tips');
    }
    ...
    public function tc(Option $option)
    {
        return view('backend/option/tc');
    }
